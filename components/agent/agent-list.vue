    ...
    <div class="space-y-4">
      ...
      <div class="border rounded-lg overflow-hidden bg-white shadow-sm">
        <div class="p-4 border-b">
          <h3 class="text-lg font-medium">Data Agen</h3>
        </div>
        <div class="p-4">
          <UiTable
            :data="agents"
      ...
      render: (_, row) => {
        return {
          ...
          slots: {
            default: `
              <button 
                @click="$emit('action', { type: 'view', row: ${JSON.stringify(row)} })"
              ...
              <button 
                @click="$emit('action', { type: 'edit', row: ${JSON.stringify(row)} })"
              ...
              <button 
                @click="$emit('action', { type: 'delete', row: ${JSON.stringify(row)} })"
